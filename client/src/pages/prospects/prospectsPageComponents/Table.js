...
const rowData = ["Id", "Email", "Status", "Firstname", "Lastname"];
const tableBodyData = ["email", "status", "firstName", "lastName"];
      ...
      <TableContainer component={Paper} className={classes.tableContainer}>
        <Table className={classes.table} aria-label="custom pagination table">
          <TableHead>
            <TableRow>
              {rowData.map((rowHead) => {
                return <StyledTableCell>{rowHead}</StyledTableCell>;
              })}
            </TableRow>
          </TableHead>
          <TableBody>
            {(rowsPerPage > 0
              ...
              <TableRow key={row.id}>
                ...
                {tableBodyData.map((tableBodyData) => {
                  return <TableCell>{row[tableBodyData]}</TableCell>;
                })}
              </TableRow>
            ))}
